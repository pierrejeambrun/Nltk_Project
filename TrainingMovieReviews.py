...
if __name__ == '__main__':
    ...
    all_words = []
    documents = []
    short_pos = open("C:/Users/Pierre/AppData/Roaming/nltk_data/corpora/movie_reviews/short_reviews/positive.txt",
                     "r").read()
    short_neg = open("C:/Users/Pierre/AppData/Roaming/nltk_data/corpora/movie_reviews/short_reviews/negative.txt",
                     "r").read()
